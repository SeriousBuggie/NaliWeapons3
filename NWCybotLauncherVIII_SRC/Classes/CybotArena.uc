...
class CybotArena expands NWReplacer config(NWConfig);

defaultproperties
{
	ReplacerLogName=CybotArena
	bArena=True
	...
	StartingWeaponClassNames(0)=CybotLauncher

	DefaultWeaponItems(0)=(bAdd=True,Item="NWCybotLauncherVIII_SRC.CybotLauncher",AmmoAmount=10,Filters="")
	...
	WeaponItems(5)=(bSwap=True,ItemToReplace="Engine.Weapon",NewItem="NWCybotLauncherVIII_SRC.CybotLauncher",ReplaceSubClasses=True,Filters="")
	
	AmmoItems(0)=(bSwap=True,ItemToReplace="BotPack.WarHeadAmmo",NewItem="X",ReplaceSubClasses=True,Filters="")
	AmmoItems(1)=(bSwap=True,ItemToReplace="Engine.Ammo",NewItem="NWCybotLauncherVIII_SRC.CybotAmmo",ReplaceSubClasses=True,Filters="")
