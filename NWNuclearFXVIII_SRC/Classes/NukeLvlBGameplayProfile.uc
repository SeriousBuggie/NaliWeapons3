...
class NukeLvlBGameplayProfile expands NukesGameplayProfile config(NWProfilesCfg);
...
defaultproperties
{
	...
	NukesProfileC(0)=(ShockRadialDmgType=1,NucleusRadialDmgType=1,ShockwaveBaseDamage=1000,NucleusBaseDamage=1600,ShockwaveDmgUpdateTime=0.050000,NucleusDmgUpdateTime=0.100000)
	...
	NukesProfileC(1)=(ShockRadialDmgType=1,NucleusRadialDmgType=1,ShockwaveBaseDamage=2000,NucleusBaseDamage=2400,ShockwaveDmgUpdateTime=0.050000,NucleusDmgUpdateTime=0.100000)
	...
	NukesProfileC(2)=(ShockRadialDmgType=1,NucleusRadialDmgType=1,ShockwaveBaseDamage=5000,NucleusBaseDamage=6000,ShockwaveDmgUpdateTime=0.050000,NucleusDmgUpdateTime=0.100000)
	NukesProfileD(2)=(ShockwaveDmgTransparencyDist=64.000000,NucleusDmgTransparencyDist=128.000000,ShockwaveMufflingFactor=0.850000,NucleusMufflingFactor=0.850000)
	...
	NukesProfileC(3)=(ShockRadialDmgType=1,NucleusRadialDmgType=1,ShockwaveBaseDamage=7000,NucleusBaseDamage=12000,ShockwaveDmgUpdateTime=0.050000,NucleusDmgUpdateTime=0.100000)
	NukesProfileD(3)=(ShockwaveDmgTransparencyDist=64.000000,NucleusDmgTransparencyDist=128.000000,ShockwaveMufflingFactor=0.850000,NucleusMufflingFactor=0.850000)
	...
	NukesProfileC(4)=(ShockRadialDmgType=1,NucleusRadialDmgType=1,ShockwaveBaseDamage=15000,NucleusBaseDamage=24000,ShockwaveDmgUpdateTime=0.050000,NucleusDmgUpdateTime=0.100000)
	...
	NukesProfileC(5)=(ShockRadialDmgType=1,NucleusRadialDmgType=1,ShockwaveBaseDamage=5000,NucleusBaseDamage=6000,ShockwaveDmgUpdateTime=0.050000,NucleusDmgUpdateTime=0.100000)
	NukesProfileD(5)=(ShockwaveDmgTransparencyDist=64.000000,NucleusDmgTransparencyDist=128.000000,ShockwaveMufflingFactor=0.850000,NucleusMufflingFactor=0.850000)
	...
	NukesProfileC(6)=(ShockRadialDmgType=1,NucleusRadialDmgType=1,ShockwaveBaseDamage=5000,NucleusBaseDamage=6000,ShockwaveDmgUpdateTime=0.050000,NucleusDmgUpdateTime=0.100000)
	NukesProfileD(6)=(ShockwaveDmgTransparencyDist=64.000000,NucleusDmgTransparencyDist=128.000000,ShockwaveMufflingFactor=0.850000,NucleusMufflingFactor=0.850000)
	...
	NukesProfileC(7)=(ShockRadialDmgType=1,NucleusRadialDmgType=1,ShockwaveBaseDamage=5000,NucleusBaseDamage=6000,ShockwaveDmgUpdateTime=0.050000,NucleusDmgUpdateTime=0.100000)
	NukesProfileD(7)=(ShockwaveDmgTransparencyDist=64.000000,NucleusDmgTransparencyDist=128.000000,ShockwaveMufflingFactor=0.850000,NucleusMufflingFactor=0.850000)
}