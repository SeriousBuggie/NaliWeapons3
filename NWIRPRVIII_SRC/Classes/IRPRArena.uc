...
class IRPRArena expands NWReplacer config(NWConfig);

defaultproperties
{
	ReplacerLogName=IRPRArena
	bArena=True
	...
	StartingWeaponClassNames(0)=IRPR
	
	DefaultWeaponItems(0)=(bAdd=True,Item="NWIRPRVIII_SRC.IRPR",AmmoAmount=50,Filters="")
	...
	WeaponItems(5)=(bSwap=True,ItemToReplace="Engine.Weapon",NewItem="NWIRPRVIII_SRC.IRPR",ReplaceSubClasses=True,Filters="")
	
	AmmoItems(0)=(bSwap=True,ItemToReplace="BotPack.WarHeadAmmo",NewItem="X",ReplaceSubClasses=True,Filters="")
	AmmoItems(1)=(bSwap=True,ItemToReplace="Engine.Ammo",NewItem="NWIRPRVIII_SRC.IRPRAmmo",ReplaceSubClasses=True,Filters="")
